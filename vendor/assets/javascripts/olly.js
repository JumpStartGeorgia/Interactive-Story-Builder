...
(function () {
    ...
    var Olly = function () {
        ...
        self.EMBED = 2;
        self.onReady = null;
        self.onSuccessEvent = null;
        self.onFailEvent = null;
        ...
        self.embed = function (URLString, element, onSuccessEvent, onFailEvent, services) {
            var URL;

            if (onSuccessEvent != undefined){
              this.onSuccessEvent = onSuccessEvent;
            }
            if (onFailEvent != undefined){
              this.onFailEvent = onFailEvent;
            }
...
(function (olly, document) {
    ...
    olly.render = function (element, URL, services) {
        ...
        if ((!domainName && !extensionName) || (services || {})[domainName] == olly.TEXT) {
            // url is not valid, so call fail event if exists
            if (this.onFailEvent != null && this.onFailEvent != undefined){
              window[this.onFailEvent]();
            }
    ...
    olly.generate = function (template, data) {
        ...
        // if success event exists, call it
        if (this.onSuccessEvent != null && this.onSuccessEvent != undefined){
          window[this.onSuccessEvent]();
        }
        return output;
    };
}(
