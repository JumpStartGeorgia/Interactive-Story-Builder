...
set :application, "Chai-Khana-Staging" # unique name of application
set :user, "chai-khana-staging" # name of user on server
...
set :git_branch_name, "chaikhana_permalink_history" # name of branch to deploy
