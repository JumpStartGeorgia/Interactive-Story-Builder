...
##### SET THESE VARIABLES ########
##################################
AS_USER=story-builder-staging # name of user on server
APP_ROOT=/home/story-builder-staging/Story-Builder-Staging/current # path to application current folder
