...
module BootstrapStarter
  class Application < Rails::Application
    ...
    config.assets.precompile += %w( author.css authors.css collaborators.css devise.css embed.css filter.css grid.css modalos.css navbar.css navbar2.css news.css root.css settings.css stories.css storyteller.css todo.css )
